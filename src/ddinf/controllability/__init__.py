...
``thm:data-fattorini-hautus``; :mod:`ddinf.controllability.window` implements
...
from .state import (
                    ...
                    ModeCandidate,
                    data_driven_controllability,
                    hautus_uncontrollable,
)
from .window import WindowCandidate, WindowRecord, io_shift_windows, io_window_controllability
